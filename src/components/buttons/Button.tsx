...
const defaultBtnClass = 'px-4 py-2 outline-none rounded font-medium active:scale-95 hover:bg-primary-dark hover:text-white focus:ring-2 focus:ring-primary-dark disabled:bg-gray-400/80 disabled:shadow-none disabled:cursor-not-allowed transition-colors duration-200';
