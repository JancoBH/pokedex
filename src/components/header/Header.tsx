          ...
          <div className="max-w-6xl mx-auto px-5 xl:px-0">
            <div className="flex items-center justify-between h-20">
              ...
              <div className="flex items-center gap-2 sm:static sm:inset-auto sm:pr-0">
                ...
                <Image src={'/icon_sort.svg'} alt={'Sort'} title={'Search'} width={40} height={30} className={iconCss} />
                <Image src={'/icon_search.svg'} alt={'Search'} title={'Search'} width={35} height={36} className={iconCss} />
